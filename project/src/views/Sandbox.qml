...
Page {
    ToolBar {
        ...
        RowLayout {
            ...
            Text {
                id: goal
                color: "white"
                text: "Your goal: " + JS.getGoal("Sandbox.qml")
            }
        }
    ...
    Rectangle {
        ...
        Board {
            ...
            Result {
                id: calc
                correctAnswer: JS.getGoal("Sandbox.qml")
                onCorrectAnswer: {
                    success.open()
            ...
            Menu {
                ...
                Menu {
                    ...
                    MenuItem {
                        text: "Var"
                        onClicked: {
                            Qt.createQmlObject('import varnode 1.0;
                                    VarNode {x:'+curs.getCursor(window.x,window.y).x+'
                ...
                Menu {
                    ...
                    MenuItem {
                        text:"Print"
                        onClicked: {
                            Qt.createQmlObject('import printnode 1.0;
